class CertificationsController < ApplicationController
  ...
  private
    ...
    def certification_params
      params.require(:certification).permit(:certification_name, :certification_type, :certification_provider, :certification_issued, :certification_expiry, :certification_description, :user_id)
    end
end
